...
progressDialog=new ProgressDialog(getActivity());
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent i = new Intent(getContext().getPackageManager().getLaunchIntentForPackage("org.tensorflow.demoj"));
                if(i!=null){
                    startActivity(i);
                }
            }
            ...
            public void onResults(Bundle bundle) {
                ...
                if (matches != null) {
                    ...
                    if (input.contains("estoy viendo") || input.contains("ayúdame a ver")
                        ...
                        Intent i = new Intent(getContext().getPackageManager().getLaunchIntentForPackage("org.tensorflow.demoja"));
                        if(i!=null){
                            startActivity(i);
                        }
                    }
